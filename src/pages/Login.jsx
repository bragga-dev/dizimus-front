        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-between p-12 w-full">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/40 text-xs">+5.000 igrejas ativas</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-16">
          <div className="w-full max-w-sm">
            ...
            <p className="text-center text-white/20 text-xs mt-4">
              ...
              <Link to="/terms" className="hover:text-white/35 transition-colors">Termos</Link>
              {' '}e{' '}
              <Link to="/privacy" className="hover:text-white/35 transition-colors">Privacidade</Link>
            </p>
          </div>
        </div>
