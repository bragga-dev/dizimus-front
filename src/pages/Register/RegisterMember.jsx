...
import { Mail, Lock, Eye, EyeOff, ArrowRight, User, Users, Gift } from 'lucide-react'
          ...
          <div className="relative z-10 flex flex-col justify-between p-12 w-full">
            ...
            <div>
              ...
              <p className="text-white/50 text-sm">
                Acesse conteúdos, eventos e mantenha-se conectado.
              </p>
            </div>
            <div className="space-y-3">
              {[
                'Acompanhe atividades da igreja',
                'Receba notificações importantes',
                'Participe de eventos e ministérios',
              ].map(item => (
