...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Building2, User, MapPin, Phone } from 'lucide-react'
          ...
          <div className="relative z-10 flex flex-col justify-between p-12 w-full">
            ...
            <div>
              ...
              <p className="text-white/50 text-sm">
                Junte-se a milhares de igrejas que confiam no Ecclesia.
              </p>
            </div>
            <div className="space-y-3">
              {[
                'Dashboard completo para gestão',
                'Controle de membros e ministérios',
                'Financeiro transparente e relatórios',
              ].map(item => (
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-[#6FB68A] text-xs font-semibold uppercase tracking-wider">
                  Cadastro de Igreja
                </span>
              </div>
