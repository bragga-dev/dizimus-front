        ...
        <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-between p-12 w-full">
            ...
            <div>
              ...
              <p className="text-white/50 text-sm">Junte-se a milhares de igrejas que confiam no Ecclesia.</p>
            </div>
            <div className="space-y-3">
              {['Dashboard completo para gestão', 'Controle de membros e ministérios', 'Financeiro transparente e relatórios'].map(item => (
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-[#6FB68A] text-xs font-semibold uppercase tracking-wider">Cadastro de Igreja</span>
              </div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-2xl font-black text-white" style={{ fontFamily: 'var(--font-ecclesia)' }}>Cadastre sua igreja</h1>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="email" value={formData.email} onChange={e => update('email', e.target.value)}
                    ...
                    placeholder="igreja@email.com" required />
                </div>
              </div>
