  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle,#D7B36A,transparent)"
        }}
      />
        ...
        >
          ...
          >
            ...
            <span
              style={{
                background:
                  "linear-gradient(90deg,#315C4B,#D7B36A)",
          ...
          <p
            ...
            "
          >
            Organize pessoas, finanças,
            eventos e comunicação em um
            ambiente construído para apoiar
            o crescimento do ministério.
          </p>
        </div>
