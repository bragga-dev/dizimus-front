...
export default function Footer() {
  return (
    <footer className="bg-dizimus-950 border-t border-white/6 pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-10 mb-14">
          ...
          <div className="col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-8 h-8 rounded-lg bg-dizimus-500/20 border border-dizimus-500/30 flex items-center justify-center">
              ...
              <span className="text-white font-extrabold text-lg tracking-tight">dizimus</span>
            </div>
          ...
          <div>
            ...
            <p className="text-xs text-white/30 mb-4 leading-relaxed">Receba conteúdos e novidades do Dizimus.</p>
            <div className="flex gap-2">
              <input
                type="email"
                placeholder="Seu melhor e-mail"
                className="min-w-0 flex-1 rounded-lg border border-white/10 bg-white/6 px-3 py-2 text-xs text-white placeholder-white/20 outline-none focus:border-dizimus-500 transition-colors"
              />
              <button className="shrink-0 rounded-lg bg-dizimus-500 px-3 py-2 text-white transition-colors hover:bg-dizimus-400">
        ...
        <div className="border-t border-white/8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/20">© 2025 Dizimus. Todos os direitos reservados.</p>
